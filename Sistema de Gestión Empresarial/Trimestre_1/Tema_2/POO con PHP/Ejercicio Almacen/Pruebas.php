<?php 
    ...
    $agua1 = new Agua_Mineral("Galicia", 1.5, 3, "Sousas", "Manantial");
    
    $azucarada1 = new Bebidas_Azucarada(5, 0, 2, 10, "CocaCola");
    $azucarada2 = new Bebidas_Azucarada(5, 0, 2, 5, "CocaCola");
